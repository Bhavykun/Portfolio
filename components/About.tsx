    ...
    >
      ...
      >
        ...
        >
          ...
          >
            {infoList.map(({ icon, iconDark, title, description }, index) => (
              <motion.li
                ...
                className="border-[0.5px] border-gray-400 rounded-xl p-6 hover:bg-[#fcf4ff] hover:-translate-y-1 duration-500 hover:shadow-[4px_4px_0px_#000] dark:border-white dark:hover:shadow-white dark:hover:bg-[#2a004a]/50"
                key={index}
              >
                <Image
          ...
          className="my-6 text-gray-900 font-ovo dark:text-white/80">
            Tools I use
          </motion.h4>
          <motion.ul 
          initial ={{opacity:0,}}
